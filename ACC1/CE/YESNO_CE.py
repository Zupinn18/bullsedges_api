...
data_file_path = "35510CE.csv"

graph_file_path = "35510CE.html"
...
subscribe_list = [alice.get_instrument_by_token('NFO', 35510)]
alice.subscribe(subscribe_list)
print(datetime.now())
sleep(10)
print(datetime.now())
...
def calculate_heikin_ashi(data):
    ...
    label_csv_filename = 'label_35510CE_15.csv'
    try:
