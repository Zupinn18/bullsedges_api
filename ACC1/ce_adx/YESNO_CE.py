...
data_file_path = "41409CE.csv"

graph_file_path = "41409CE.html"
...
subscribe_list = [alice.get_instrument_by_token('NFO', 41409)]
alice.subscribe(subscribe_list)
print(datetime.now())
sleep(10)
print(datetime.now())
...
def calculate_heikin_ashi(data):
    ...
    label_csv_filename = 'label_41409CE.csv'
    try:
