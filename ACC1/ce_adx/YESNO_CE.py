...
data_file_path = "72248CE.csv"

graph_file_path = "72248CE.html"
...
subscribe_list = [alice.get_instrument_by_token('NFO', 72248)]
alice.subscribe(subscribe_list)
print(datetime.now())
sleep(10)
print(datetime.now())
...
def calculate_heikin_ashi(data):
    ...
    label_csv_filename = 'label_72248CE.csv'
    try:
