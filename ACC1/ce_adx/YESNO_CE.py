...
data_file_path = "66696PE.csv"

graph_file_path = "66696PE.html"
...
subscribe_list = [alice.get_instrument_by_token("NFO", 66696)]
alice.subscribe(subscribe_list)
print(datetime.now())
sleep(10)
print(datetime.now())
...
def calculate_heikin_ashi(data):
    ...
    label_csv_filename = 'label_66609_CE.csv'
    try:
