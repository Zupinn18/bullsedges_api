...
data_file_path = "55811CE.csv"

graph_file_path = "55811CE.html"
...
subscribe_list = [alice.get_instrument_by_token('NFO', 55811)]
alice.subscribe(subscribe_list)
print(datetime.now())
sleep(10)
print(datetime.now())
...
# Update layout to include the new components
app.layout = html.Div([
