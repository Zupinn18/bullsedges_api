...
data_file_path = "72245PE.csv"

graph_file_path = "72245PE.html"
...
subscribe_list = [alice.get_instrument_by_token('NFO', 72245)]
alice.subscribe(subscribe_list)
print(datetime.now())
sleep(10)
print(datetime.now())
...
def calculate_heikin_ashi(data):
    ...
    label_csv_filename = 'label_72245PE.csv'
    try:
