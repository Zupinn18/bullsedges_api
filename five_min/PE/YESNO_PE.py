...
data_file_path = "39169PE.csv"

graph_file_path = "39169PE.html"
...
subscribe_list = [alice.get_instrument_by_token('NFO', 39169)]
alice.subscribe(subscribe_list)
print(datetime.now())
sleep(10)
print(datetime.now())
...
def calculate_heikin_ashi(data):
    ...
    label_csv_filename = 'label_39169PE_8.csv'
    try:
...
# Read the 'label_39169CE_17.csv' and 'band_data.csv' files
