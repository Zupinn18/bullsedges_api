...
data_file_path = "40707CE.csv"

graph_file_path = "40707CE_02.html"
...
subscribe_list = [alice.get_instrument_by_token('NFO', 40707)]
alice.subscribe(subscribe_list)
print(datetime.now())
sleep(10)
print(datetime.now())
...
def calculate_heikin_ashi(data):
    ...
    label_csv_filename = 'label_40707CE_02.csv'
    try:
...
# Read the 'label_40728CE_17.csv' and 'band_data.csv' files
